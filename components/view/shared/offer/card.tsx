  ...
  return (
    <div className={style.cardText}>
      <div
        ...
        style={{ boxShadow: "rgba(53, 49, 72, 0.09) 0px 3px 11px" }}
      >
...
function StatsBar() {
  return (
    <div className="min-h-[10em] min-w-[10em]">
      <div className="translate-x-[40%] h-[100%] ">
        <img
          src={Images.Landing.bar.src}
          className="w-[100%] h-[100%] object-contain"
        />
        <div className="absolute top-[45%] bottom-[50%] minitab:left-[20%] left-[15%] translate-y-[-50%] font-[700] font-Museo">
          10%
        </div>
      </div>
    </div>
...
function CardItem({ text, color }: CardItemProps) {
  return (
    <div className="flex gap-[0.5em] items-center mb-[0.05em]">
