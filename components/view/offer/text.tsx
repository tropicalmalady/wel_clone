...
const style = {
    ...
    max-w-[100%] px-[20] text-center  mx-[auto]`,
...
export default function OfferText() {
    return <div className={style.wrapper}>
        <div className={style.title}>
            <h2 className="minitab:mb-[0.7em] mb-[0.5em]">You're in the driver's seat</h2>
        </div>
        <div className={style.content}>
            <div className="minitab:mb-[2em] mb-[1em]">
                <p >What do you want your bank account to look like in 10 years? Weltio clears the path to shares of some of the world's most exciting companies</p>
            </div>
            <Action />
        </div>
    </div>
