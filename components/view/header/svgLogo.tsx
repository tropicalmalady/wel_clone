...
export default function LogoSvg() {
    ...
    return <div onPointerOver={() => setHasMouseEntered(true)} onPointerOut={() => setHasMouseEntered(false)} >
      ...
      <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 90 27" style={{ fill: "rgb(11, 30, 91);" }} >
        ...
        <motion.path d="M86.11 24.26a1.95 1.95 0 1 1 3.9 0 1.95 1.95 0 1 1-3.9 0Z" data-svg-origin="88.06000137329102 26.21000099182129"
          animate={{
            y: hasMouseEntered ? [2.47666, -15, -17] : 2.47666,
            originX: "0px",
            originY: "0px"
          }}
  
          transition={{ times: [0, 0.5, 0.8], duration: 0.8 }}
          className="">
        </motion.path> </svg>
    </div>
  }
