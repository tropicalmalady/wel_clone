...
const FeatureCardOne: FeatureCardProps = {
  cardText: {
    ...
    content:
      "The US dollar is one of the most stable currencies on the planet. With Weltio, you can open a fully regulated and fully protected USD account",
  },
  ovalResource: { resource: Images.Landing.featureCard1 },
  popupCardOne: (
    <div className="desktop:left-[-40%] minitab:top-[3%] minitab:left-[-23%] left-[-50px] top-[50%] absolute z-[1]">
      <PopupCardOne />
    </div>
  ),
  popupCardTwo: (
    <div className="desktop:right-[-35%] minitab:right-[-15%] minitab:bottom-[10%] right-[-50px] bottom-[-20px] absolute">
      <PopupCardTwo />
    </div>
  ),
};
...
const FeatureCardTwo: FeatureCardProps = {
  cardText: {
    ...
    content:
      "Investing is for everyone! Whether you're a beginner or a seasoned pro, we welcome investors of all levels",
  },
  ovalResource: {
    resource: Images.Landing.featureCard2,
    horizontal: true,
    backgroundColor: "bg-primaryColors-cream100",
  },
  popupCardOne: (
    <div className="minitab:top-[-2%] minitab:left-[0%] left-[50%] top-[0%] absolute z-[1]">
      <PopupCardThree />
    </div>
  ),
  popupCardTwo: (
    <div className="minitab:left-[-5%] minitab:bottom-[12%] left-[-10%] bottom-[10%] absolute">
      <PopupCardFour />
    </div>
  ),
};
...
const FeatureCardThree: FeatureCardProps = {
  ...
  popupCardOne: (
    <div className="desktop:left-[-55%] desktop:top-[-15%] minitab:top-[3%] minitab:left-[-30%] left-[-35%] top-[-10%] absolute z-[1]">
      <PopupCardFive />
    </div>
  ),
  popupCardTwo: (
    <div className="desktop:right-[-45%] desktop:bottom-[-10%] minitab:right-[-20%] minitab:bottom-[5%] right-[-50px] bottom-[-30px] absolute">
      <PopupCardSix />
    </div>
  ),
};
